...
H='https://raw.githubusercontent.com/nothing032/BombSquadPlugins01/main/WonderBomb_api8.py'
I='https://raw.githubusercontent.com/nothing032/BombSquadPlugins01/main/WonderBomb_api9.py'
def B():
	G='error'
	try:
		...
		E=A.env()['python_directory_user'];B='Wonder.py';F=[O for O in os.listdir(E)if re.match('^Wonder(\\s*\\(\\d+\\))?\\.py$',O,re.I)]
